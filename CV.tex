...
\item{04 Jan 2016 - 07 Sep 2017}
     ...
     {C++ Linux developer}                                           \\
Developing core functionality for a large C++ system, subject to certifacion, legistlation and money handling.
Some of the daily tasks include:                                     \\
- GNU utilities, Linux sockets, IPC, multithreading, bash scripting  \\
- C++14, CMake, clang-tidy                                           \\
- OpenGL, SDL2                                                       \\
- Bill acceptor device failsafe communication and control            \\
