...
\item{Jul 2022 - now}
     ...
     {Networking}  \\
Developed and maintained an encrypted messaging application using Python, ffmpeg, and systemd supervision.
Designed a public-facing web interface to expose project documentation, requiring robust security measures.
